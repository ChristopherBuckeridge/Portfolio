...
if (!function_exists('engineering_manufacturing_enqueue_scripts')) {
	...
	function engineering_manufacturing_enqueue_scripts() {
		...
		wp_add_inline_style( 'engineering-manufacturing-style', $css );
...
function engineering_manufacturing_logo_resizer() {
	...
	';
    wp_add_inline_style( 'engineering-manufacturing-style',$theme_logo_size_css );	
...
if (!function_exists('engineering_manufacturing_comment')) :
     ...
     */
    function engineering_manufacturing_comment($comment, $args, $depth){
 ...
 */
add_filter('loop_shop_columns', 'engineering_manufacturing_loop_columns', 999);
...
add_action( 'wp_enqueue_scripts', 'engineering_manufacturing_load_dashicons_front_end' );
function engineering_manufacturing_load_dashicons_front_end() {
